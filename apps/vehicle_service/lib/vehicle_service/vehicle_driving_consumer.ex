defmodule VehicleService.VehicleDrivingConsumer do
  ...
  alias VehicleService.{Vehicles, Vehicle, Journeys}
  alias Ecto.Changeset

  def queue_name, do: "vehicle_journeys"
  ...
  def handle_message(_processor, %Message{data: vehicle} = message, _context) do
    {new_x, new_y} = Journeys.increment_step(vehicle)
    is_destination_reached? = Journeys.is_destination_reached?(vehicle)
